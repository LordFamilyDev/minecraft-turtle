...
local function layeredMining()
    for layer = 0, TOTAL_LAYERS - 1 do
        ...
        for x = startX, MAIN_SHAFT_LENGTH do
            ...
            if turtle.getFuelLevel() < 1000 then
                if not lib_mining.refuel() then
                    print("Low on fuel. Aborting operation.")
                    return false
                end
            end
            ...
            if (x - startX) % SIDE_SHAFT_INTERVAL == 0 then
                ...
                for y = 1, SIDE_SHAFT_LENGTH do
                    ...
                    lib_mining.checkAndHandleBlock(turtle.inspect, turtle.place, turtle.place, turtle.dig, "to the front")
                ...
                returnToStart(0, SIDE_SHAFT_LENGTH, 0)
                turtle.turnRight()
        ...
        if not returnToStart(MAIN_SHAFT_LENGTH - startX + 1, 0, startZ) then
